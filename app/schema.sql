...
INSERT INTO `infopersonal`.`t_infopersonal` (`nombre`, `aPaterno`, `aMaterno`, `Matricula`, `fechaNac`, `especialidad`, `sexo`, `Archivo`) VALUES ('Jose Alberto', 'Velazquez', 'Nava', '191190060', '2001/04/16', 'Desarrollo de Paginas Web', 'Masculino', 'img');
